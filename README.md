...
- **سرور B** (سرور دریافت کننده ترافیک کاربران) با دسترسی root
- **سرور A** (سرور دریافت کننده ترافیک از B) با پراکسی تلگرام یا سایر اپلیکیشن‌ها نصب شده
...
3. اطلاعات خواسته شده را وارد کنید:
   ...
   - IP سرور A (سرور دریافت کننده ترافیک از B)
   - پورت پراکسی/اپلیکیشن روی سرور A
   - پورت‌های مورد نیاز
